...
//1. 首先进行填充， 补充0x10000... 补足  %512 余数 为448, 之后添加补充前长度 (bit) 此处注意cpu 使用为大端还是小端， 比如长度 0x28,
...
//	??? 这里对于大端小端cpu读出的值是不同的，是否在RFC中规定了应该以大端还是小端来读取数值
//	这个问题可以参考下 RFC 以及 golang标准库中的处理
//3. 将step 2中 a/b/c/d 组合成为 128bit 结果即可
